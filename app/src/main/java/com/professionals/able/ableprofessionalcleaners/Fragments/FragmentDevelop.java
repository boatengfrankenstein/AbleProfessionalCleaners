package com.professionals.able.ableprofessionalcleaners.Fragments;
...
import com.example.javier.MaterialDesignApp.MainActivity_Material;
...
public class FragmentDevelop extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((MainActivity_Material) getActivity()).getSupportActionBar().setTitle("Develop");
